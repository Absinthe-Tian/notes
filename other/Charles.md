...
说明：本次破解Mac的5.0beta版本。

1. 前往[Charles Beta](https://www.charlesproxy.com/download/beta/)下载并安装Mac版本。
1. 获取注册码：[Charles破解工具](https://www.zzzmode.com/mytools/charles/)，随便输入用户名，点击生成即可获取注册码。
1. 打开Charles -> help -> register to xxx，输入用户名和注册码。

> 如果该在线工具不可用，可在[Go Play](https://go.dev/play/)执行以下代码：
